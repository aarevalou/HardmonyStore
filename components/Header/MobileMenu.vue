<template>
    <div class="dropdown d-xl-none d-lg-none mr-auto">
        ...
        <div class="dropdown-menu hb" aria-labelledby="navd">
            <NuxtLink class="dropdown-item" to="/">INICIO</NuxtLink>
            <NuxtLink class="dropdown-item" to="/products">PRODUCTOS</NuxtLink>
            <NuxtLink class="dropdown-item" to="/contact">CONTACTO</NuxtLink>
        </div>
    </div>
</template>