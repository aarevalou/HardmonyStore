  ...
  <div>
    <div class="row mb-5">
      <div class="col6 col-xl-6 col-lg-6 col-md-12 col-sm-12">
        <img class="img-fluid" :src="useAsset(item.imagen!)">
      </div>
      ...
      <div class="col6 col-xl-6 col-lg-6 col-md-12 col-sm-12 d-flex align-items-center justify-content-start">
        <div class="info pt-xl-0 pt-lg-0 pt-5">
          ...
          <h6 style="width:190px;">3 reseñas</h6>
          <h1 class="font-weight-bold text-uppercase pt-3">{{ item.modelo }}</h1>
          <h4>${{ item.precio }}</h4>
          <br><br><br>
          ...
          <button class="add-to-cart-button" @click="addtoCart(item)">AGREGAR +</button>
        </div>
      </div>
    </div>
  </div>
